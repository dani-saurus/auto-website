    ...
    <header>
        <div class="advertorials">
            ...
            <div class="advertorial">
                ...
                <img src="../public/assets/images/car-rent-header-image-2.png" alt="">
                <img src="../public/assets/images/header-block-background.svg" alt="" class="background-header-element">
        ...
        <?php for ($i = 0; $i <= 3; $i++) : ?>
            <div class="car-details">
                ...
                <div class="car-specification">
                    <span><img src="../public/assets/images/icons/gas-station.svg" alt="">90l</span>
                    <span><img src="../public/assets/images/icons/car.svg" alt="">Schakel</span>
                    <span><img src="../public/assets/images/icons/profile-2user.svg" alt="">2 Personen</span>
                </div>
        ...
        <?php for ($i = 4; $i <= 11; $i++) : ?>
            <div class="car-details">
                ...
                <div class="car-specification">
                    <span><img src="../public/assets/images/icons/gas-station.svg" alt="">90l</span>
                    <span><img src="../public/assets/images/icons/car.svg" alt="">Schakel</span>
                    <span><img src="../public/assets/images/icons/profile-2user.svg" alt="">2 People</span>
                </div>
                <div class="rent-details">
                    <span><span class="font-weight-bold">€249,00</span> / dag</span>
                    <a href="/car-detail" class="button-primary">Bekijk nu</a>
